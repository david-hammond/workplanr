...
#' @keywords internal
get_staff = function(db_name = "my_workplan.sqlite"){
...
#' @param db_name The name of the database to create 
#' @keywords internal
get_projects = function(db_name = "my_workplan.sqlite"){
  con <- RSQLite::dbConnect(RSQLite::SQLite(), dbname= db_name)
...
#' @param db_name The name of the database to create 
#' @keywords internal
get_project_phases = function(db_name = "my_workplan.sqlite"){
  con <- RSQLite::dbConnect(RSQLite::SQLite(), dbname= db_name)
...
#' @param db_name The name of the database to create 
#' @keywords internal
get_out_of_office = function(db_name = "my_workplan.sqlite"){
  con <- RSQLite::dbConnect(RSQLite::SQLite(), dbname= db_name)
  rs <- RSQLite::dbGetQuery(con, "SELECT id_out_of_office, staff_name, 
                             out_of_office_start, 
                             out_of_office_end, 
                             work_related 
                             FROM out_of_office 
...
#' @param db_name The name of the database to create 
#' @keywords internal
get_public_holidays = function(db_name = "my_workplan.sqlite"){
  con <- RSQLite::dbConnect(RSQLite::SQLite(), dbname= db_name)
...
#' @param db_name The name of the database to create 
#' @keywords internal
get_calendar = function(db_name = "my_workplan.sqlite"){
  con <- RSQLite::dbConnect(RSQLite::SQLite(), dbname= db_name)
...
#' @param db_name The name of the database to create 
#' @keywords internal
get_time_estimates = function(db_name = "my_workplan.sqlite"){
  con <- RSQLite::dbConnect(RSQLite::SQLite(), dbname= db_name)
  rs <- RSQLite::dbGetQuery(con, "SELECT project_name, project_phase_name, project_start, project_end, 
