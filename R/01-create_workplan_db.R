...
init_db = function(db_name = "my_workplan.sqlite"){
  ...
  rs <- RSQLite::dbSendQuery(db, statement = "CREATE TABLE `calendar` 
  ...
  rs <- RSQLite::dbSendQuery(db, statement = "CREATE TABLE `projects` 
              ...
              `project_end` TEXT )")
  RSQLite::dbClearResult(rs)
  rs <- RSQLite::dbSendQuery(db, statement = "CREATE TABLE `project_phases` 
  ...
  RSQLite::dbClearResult(rs)
  rs <- RSQLite::dbSendQuery(db, statement = "CREATE TABLE `public_holidays` 
